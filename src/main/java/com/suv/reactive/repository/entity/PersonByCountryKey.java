package com.suv.reactive.repository.entity;
...
public class PersonByCountryKey implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 8806548694147647785L;
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(country, that.country) && Objects.equals(firstName, that.firstName)
				&& Objects.equals(lastName, that.lastName) && Objects.equals(id, that.id);
	}
	...
	public String toString() {
		return "PersonByCountryKey{" + "country='" + country + '\'' + ", firstName='" + firstName + '\''
